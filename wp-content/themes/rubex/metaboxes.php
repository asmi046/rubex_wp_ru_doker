...
Container::make( 'theme_options', 'as_theme_options', 'Настройки темы' )
  //Главная страница
    ...
    ->add_tab('Продуктовый магазин', array(
      // Field::make( 'file', 'as_catalog_file_1', 'Каталог (Конвейерная лента)')
      //   ->set_value_type('url')
      //   ->set_width(50),
      ...
      Field::make( 'image', 'as_menu_photo_1', 'Фото в меню (Конвейерная лента)')
        ...
        Field::make('text', 'as_catalog_file_2', 'Название Константы (Промышленные рукава)')
          ->set_width(50),
      // Field::make( 'file', 'as_catalog_file_2', 'Каталог (Промышленные рукава)')
      //   ->set_value_type('url')
      //   ->set_width(50),
      Field::make( 'image', 'as_menu_photo_2', 'Фото в меню (Промышленные рукава)')
        ...
        Field::make('text', 'as_catalog_file_3', 'Название Константы (Рукава высокого давления)')
          ->set_width(50),
      // Field::make( 'file', 'as_catalog_file_3', 'Каталог (Рукава высокого давления)')
      //   ->set_value_type('url')
      //   ->set_width(50),
...
/*  
Container::make('post_meta', 'as_post', 'Фото и видео материалы для поста')
  ->show_on_post_type('post')
  ->add_fields(array(
    Field::make('image', 'novosti_img_1', 'Фото 1')
      ->set_width(20),
    Field::make('image', 'novosti_img_2', 'Фото 2')
      ->set_width(20),
    Field::make('file', 'novosti_vid_1', 'Видео 1')
      ->set_value_type('url')
      ->set_width(20),
    Field::make('file', 'novosti_vid_2', 'Видео 2')
      ->set_value_type('url')
      ->set_width(20),
));
*/
