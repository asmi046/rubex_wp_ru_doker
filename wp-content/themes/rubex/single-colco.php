<?php
/*
* Template Name: Кольцо уплотнительное
		  ...
		  <div class="container">
		    <div class="category-wrapper">
				...
				<?php while(have_posts()):
					...
					<?php if($table = carbon_get_the_post_meta('colco_condition')):?>
						...
						<table cellspacing="0" style="overflow:auto;">
							<thead>
								<tr class="thead-img">
									...
									<th><span class="color-white"><?_e("Внутр. диаметр трубопровода, мм","rubex");?></span></th>
									<th><span class="color-white"><?_e("Внутр. диаметр кольца, мм","rubex");?></span></th>
									<th><span class="color-white"><?_e("Внешний. диаметр кольца, мм","rubex");?></span></th>
									<th><span class="color-white"><?_e("Высота кольца, мм","rubex");?></span></th>
								</tr>
							</thead>
							<tbody class="">
								<?php foreach($table as $tr):?>
									<tr>
										...
										<td><?php echo $tr['vnutr_colco']?></td>
										<td><?php echo $tr['vnesh_colco']?></td>
										<td><?php echo $tr['height']?></td>
									</tr>
								<?php endforeach;?>
							</tbody>
						</table>
