		  ...
		  <div class="container">
		    <div class="category-wrapper">
				...
				<?php while(have_posts()):
					...
					<?php if($table = carbon_get_the_post_meta('otvod_condition')):?>
						...
						<table cellspacing="0" style="overflow:auto;">
							<thead>
								<tr class="thead-img">
									...
									<th><span class="color-white"><?_e("AxB, мм","rubex");?></span></th>
									<th><span class="color-white"><?_e("Радиус изгиба, мм","rubex");?></span></th>
								</tr>
							</thead>
							<tbody class="">
