<?php
/*
* Template Name: Конвеерная лента (тросовая)
		    ...
		    <div class="category-wrapper">
		      ...
		      <div class="product-main">
				...
				<?php while(have_posts()):
					...
					<?php if($table = carbon_get_the_post_meta('conveer_condition_tros')):?>
					<div class="product-main__table">
						<table cellspacing="0" style="overflow:auto;">
							<thead>
								<tr class="thead-img">
									<th><span class="color-white"><?_e("Тип ленты","rubex");?></span></th>
									<th><span class="color-white"><?_e("Диаметр троса, мм","rubex");?></span></th>
									<th><span class="color-white"><?_e("Прочность при разрыве по основе Н/мм","rubex");?></span></th>
									<th><span class="color-white"><?_e("Расчетная масса ленты (кг/м2)","rubex");?></span></th>
									<th><span class="color-white"><?_e("Толщина ленты, мм","rubex");?></span></th>
									<th><span class="color-white"><?_e("Длина, м","rubex");?></span></th>
								</tr>
								<tr class="thead-inits">
									<th>Belt type</th>
									<th>Cord diameter, mm</th>
									<th>Rupture strength as per N/mm</th>
									<th>Estimated belt weight, kg/m2</th>
									<th>Belt thickness, mm</th>
									<th>Length, m</th>
								</tr>
							</thead>
							<tbody class="">
